...
export interface TouchWrapperProps {
  ...
  handleKeyDown?: KeyHandlerArray | string;
  /* Keyboard handler(s) to evaluate when the component receives a key up. */
  handleKeyUp?: KeyHandlerArray | string;
...
export const TouchWrapper = (
  props: React.PropsWithChildren<TouchWrapperProps>
) => {
  return (
    <>
      <APLComponent
