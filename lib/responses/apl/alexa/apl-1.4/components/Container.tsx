...
type directionEnum = 'column' | 'row' | 'columnReverse' | 'rowReverse';
type justifyContentEnum =
  ...
  | 'spaceAround'
  | 'spaceEvenly';
type wrapEnum = 'noWrap' | 'wrap' | 'wrapReverse';
type Entity = {
  id: string;
  type: string;
  name: string;
...
export interface ContainerProps {
  ...
  /* How children will be wrapped to multiple lines */
  wrap?: LiteralUnion<wrapEnum, string>;
  item?: any;
  items?: any;
  [key: string]: unknown;
}
