...
export interface FrameProps {
  ...
  /* Border color of this component */
  borderColor?: string;
  /* Common radius of the corners of the shape. */
  borderRadius?: dimension;
  /* Width of the border. */
  borderWidth?: dimension;
  /* Radius of the top-left corner. Overrides borderRadius */
  borderTopLeftRadius?: dimension;
  /* Radius of the top-right corner. Overrides borderRadius */
...
export const Frame = (props: React.PropsWithChildren<FrameProps>) => {
  return (
    <>
      <APLComponent
