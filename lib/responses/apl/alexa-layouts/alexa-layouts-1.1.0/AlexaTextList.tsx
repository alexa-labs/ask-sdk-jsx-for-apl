...
export interface AlexaTextListProps {
...
export const AlexaTextList = (
  props: React.PropsWithChildren<AlexaTextListProps>
) => {
  return (
    <>
      <APLImports imports={imports} />
      <ListComponent
        definition={{ type: 'AlexaTextList', ...omit(props, ['children']) }}>
        {props.children}
      </ListComponent>
    </>
  );
