...
export interface AlexaPaginatedListItemProps {
  ...
  primaryText?: string;
  /* Secondary text for fullscreen item. */
  secondaryText?: string;
  /* Tertiary text for fullscreen item. */
  tertiaryText?: string;
  /* URL for background image source. */
  backgroundImageSource?: string;
  [key: string]: unknown;
}
export const AlexaPaginatedListItem = (
  props: React.PropsWithChildren<AlexaPaginatedListItemProps>
) => {
  return (
    <>
